...
public class vote_content implements Serializable {
    ...
    public vote_content(int uid, String vote_head, String vote_name, String vote_publishtime, String vote_coverimg, String vote_title, String vote_num, boolean flag) {
        Uid = uid;
